...
class SessionsFragmentTestActivity : AppCompatActivity(), SessionsFragment.Callbacks {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        TestSessionsFragmentHooks.firstPaintScheduler = controlledFirstPaintScheduler
        TestSessionsFragmentHooks.cacheWriteScheduler = controlledCacheWriteScheduler
