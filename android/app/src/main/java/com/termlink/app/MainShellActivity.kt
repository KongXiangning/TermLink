...
class MainShellActivity : AppCompatActivity(), TerminalWebViewHost, TerminalEventBridge.Listener,
    ...
    companion object {
        private const val TERMINAL_URL = "file:///android_asset/public/terminal_client.html?v=64"
        private const val CODEX_URL = "file:///android_asset/public/codex_client.html?v=71"
