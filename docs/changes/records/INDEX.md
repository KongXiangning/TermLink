...
| CR-20260309-2245-codex-phase3-approvals | REQ-20260309-codex-capability-mvp | draft | TBD | @maintainer | 2026-03-09 | Phase 3 审批与交互状态机：统一 command/file/patch/userInput 卡片模型与恢复快照 | `docs/changes/records/CR-20260309-2245-codex-phase3-approvals.md` |
| CR-20260309-2310-codex-phase3-mobile-validation | REQ-20260309-codex-capability-mvp | draft | TBD | @maintainer | 2026-03-09 | Phase 3 手机端小屏交互收口与真机验证准备：sticky composer、审批卡片样式、资源版本与回归基线 | `docs/changes/records/CR-20260309-2310-codex-phase3-mobile-validation.md` |
