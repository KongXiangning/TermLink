...
| CR-20260224-0300-server-admin-privilege-mode-phase1 | REQ-20260222-server-admin-privilege-mode | active | TBD | @maintainer | 2026-02-24 | 管理员权限模式 Phase 1+2 实现：配置门禁、IP 白名单、审计日志 | `docs/changes/records/CR-20260224-0300-server-admin-privilege-mode-phase1.md` |
