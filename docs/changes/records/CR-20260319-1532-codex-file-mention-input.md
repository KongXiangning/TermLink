...
related_code: []
related_docs: [docs/product/requirements/REQ-20260309-codex-capability-mvp.md, docs/codex/CODEX_CAPABILITY_IMPLEMENTATION_PLAN.md, docs/codex/CODEX_FILE_MENTION_INPUT_PLAN.md, docs/product/PRODUCT_REQUIREMENTS.md, docs/changes/records/INDEX.md]
---
...
2. 在 `CODEX_CAPABILITY_IMPLEMENTATION_PLAN.md` 中把 composer `@` 文件提示收敛为 Phase 4 的独立实施包，并补入验收矩阵。
3. 新增 `docs/codex/CODEX_FILE_MENTION_INPUT_PLAN.md`，固定 TermLink 版本的技术承接方式：客户端浮层 + session cwd 文件检索 + 已选文件态 + 发送前文本拼装。
...
- 文件：
  ...
  - `docs/codex/CODEX_FILE_MENTION_INPUT_PLAN.md`
...
git checkout <commit_ref>^ -- docs/codex/CODEX_FILE_MENTION_INPUT_PLAN.md
