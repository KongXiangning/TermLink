...
related_code: [android/app/src/main/java/com/termlink/app/MainShellActivity.kt, src/server.js]
related_docs: [docs/architecture/CURRENT_STATE.md, docs/architecture/ROADMAP.md]
---

> 状态：archived；不再维护原因：阶段性计划已完成并分散到当前主线文档；替代文档：docs/architecture/CURRENT_STATE.md
