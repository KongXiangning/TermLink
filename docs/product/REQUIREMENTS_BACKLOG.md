...
| REQ-20260324-session-list-local-cache | Android 会话列表本地缓存与离线回显 | P1 | planned | @maintainer | 2026-Q2 | `docs/product/requirements/REQ-20260324-session-list-local-cache.md` |
