...
test('codex client shell uses the Phase 1 conversation-first header and shared codex scripts', () => {
    ...
    assert.match(html, /id="codex-status-cwd-row"/);
    assert.match(html, /id="codex-cwd-text"/);
    assert.doesNotMatch(html, /id="codex-brand-version"/);
    assert.doesNotMatch(html, /id="codex-status-cwd"/);
    ...
    assert.match(html, /id="btn-codex-capsule-model"/);
    assert.match(html, /id="btn-codex-capsule-reasoning"/);
    assert.match(html, /id="btn-codex-capsule-sandbox"/);
    assert.match(html, /data-i18n="codex\.capsule\.permissions"/);
    assert.match(html, /id="btn-codex-capsule-attach"/);
    ...
    assert.doesNotMatch(html, /data-i18n="codex\.capsule\.sandbox"/);
