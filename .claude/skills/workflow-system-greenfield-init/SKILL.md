...
verification:
  ...
  - "`AGENTS.md`、`CLAUDE.md`、docs/workflow/ROADMAP.md、docs/workflow/CONTRACTS.md、docs/workflow/BASELINES.md、docs/workflow/STATUS.md、docs/workflow/DECISIONS.md 已建立首版骨架"
